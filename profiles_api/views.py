...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        """
        a_viewset = ['create, retreievem update, partial_update',
                     'Automatically maps to URLs using outers',
                     'provides more funcitonality']

        return Response({'message': "Hello from View set",
                         'a_viewset': a_viewset})
